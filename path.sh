...
# export PYTHONPATH=/store/amatos/pasta/projects/segmentation/src/espnet:$PYTHONPATH
# export PYTHONPATH=/store/amatos/pasta/projects/segmentation/src/espnet/espnet2:$PYTHONPATH